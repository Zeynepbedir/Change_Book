                ...
                .addOnCompleteListener(KaydolActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            //hasmap birden fazla veriyi göndermek için kullanırız

                            HashMap<String, Object> hashMap = new HashMap<>();
                            hashMap.put("id",kullaniciId);
                            hashMap.put("kullanniciadi",kullaniciadi.toLowerCase());
                            hashMap.put("ad",ad);
                            hashMap.put("bio","");
                            hashMap.put("resimurl","https://firebasestorage.googleapis.com/v0/b/cbookapp-6760c.appspot.com/o/profil.png?alt=media&token=df75e564-276f-4d89-bbd9-288b5b111ad2");
